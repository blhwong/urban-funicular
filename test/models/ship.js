...
describe('Ship model', () => {
  ...
  describe('constructor', () => {
    ...
    it('does not expect direction for ships at size 1', () => {
      ...
      expect(() => new Ship(1, 1, 2)).to.throw();
      expect(() => new Ship(1, 1, 2, 'blah')).to.throw();
    ...
    it('will throw error on bad inputs', () => {
      expect(() => new Ship(null, undefined, '1', 'test')).to.throw();
      expect(() => new Ship(-1, -1, '1', 'test')).to.throw();
    });
  });
